  ...
  lang.extend(WireIt.WiringEditor, WireIt.BaseEditor, {
    ...
    setOptions: function(options) {
      ...
      this.options.modulesAccordionViewParams = YAHOO.lang.merge({
        collapsible: true,
        expandable: true,
        // remove this parameter to open only one panel at a time
        width: 'auto',
        expandItem: 0,
        animationSpeed: '0.3',
        animate: true,
    ...
    save: function(name) {
      ...
      return this.tempSavedWiring.working;
    },
    ...
    /**
     * @method loadPipe
     * @param {String} pipe data
     */
    loadPipe: function(wiring) {
      try {
        this.preventLayerChangedEvent = true;

        if (!wiring) {
          this.alert("The wiring was not found.");
          return;
        }
